...
public class Interfaz_notas extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String[] columnas = {"No carnet","Materia"};
    ...
    if(!doc.equals("") && !mate.equals("") && nota>=1 && nota<=10)
        {
        ...
        {
          JOptionPane.showMessageDialog(this, "Faltan registros o la nota no es valida es de rango 1 a 10 ");  
        }    
